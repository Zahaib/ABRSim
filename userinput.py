...
class parseinput(object):
  ...
  def __init__(self):
    ...
    parser = OptionParser(usage="%prog <inputfile> [OPTIONS]", version="%prog 1.0", epilog="For bugs and suggestions, email: <zakhtar@usc.edu> <nam21@purdue.edu>", formatter=MyTitledHelpFormatter())
